...
public enum Medalha {
	...
	NITRO_BOOSTER("Nitro Booster", ChatColor.LIGHT_PURPLE, "✦",
			...
			"medalha.especial.nitrobooster", MedalhaCategoria.ESPECIAL),
	BUG_BOUNTY("Bug Bounty", ChatColor.YELLOW, "🛠", "Medalha concedida aos jogadores que reportaram um bug no Servidor.",
			"medalha.especial.bugbounty", MedalhaCategoria.ESPECIAL),
	EX_STAFFER("Ex-Staffer", ChatColor.AQUA, "🛡",
			"Medalha concedida aos jogadores que fizeram parte da nossa equipe.", "medalha.especial.exstaffer",
			MedalhaCategoria.ESPECIAL),
	CASAS_DO_SUDANO("Casas do Sudano", ChatColor.RED, "🏠", "Medalha concedida aos crias/amigos do Sudano.",
			"medalha.especial.casasdosudano", MedalhaCategoria.ESPECIAL),
