...
public enum PlayerGroup {
	...
	DEVELOPER("Developer", "tag.developer", ChatColor.DARK_AQUA),
	...
	TRIALMOD("TrialMod", "tag.trialmod", ChatColor.LIGHT_PURPLE),
	AJUDANTE("Ajudante", "tag.ajudante", ChatColor.BLUE),
	STAFFER("Staffer", "tag.staffer", ChatColor.DARK_GREEN),
	YOUTUBERPLUS("YouTuber+", "tag.youtuber+", ChatColor.DARK_AQUA),
	YOUTUBER("YouTuber", "tag.youtuber", ChatColor.AQUA),
	PARTNER("Partner", "tag.partner", ChatColor.GOLD),
