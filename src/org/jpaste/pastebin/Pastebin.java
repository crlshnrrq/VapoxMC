...
public class Pastebin {
	 ...
	 * 
	 * @param developerKey a developer key which can be fetched from the pastebin
	 *                     API page
...
//	 * 
//	 * The options for the post are: limit: up to 500. default is 50. lang: any of
//	 * the syntaxes allowed for Pastebin.
//	 * 
